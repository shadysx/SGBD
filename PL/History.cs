...
namespace PL
{
    public partial class History : Form
    {
        ...
        {
            HistoryPurchaseItem basketItem = new HistoryPurchaseItem(iD_ORDERED, iD_ORDER_LINE, oRDER_LINE_QUANTITY, oRDER_LINE_BUYING_PRICE, iD_SHOP, sHOP_NAME, sHOP_ADDRESS, sHOP_CITY, sHOP_COUNTRY, iD_PRODUCT, pRODUCT_NAME, pRODUCT_TYPE, pRODUCT_DESCRIPTION, pICTURE_URL, pICTURE_PATH);
